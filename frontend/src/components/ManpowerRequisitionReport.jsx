...
//         const worksheet = XLSX.utils.json_to_sheet(dataToExport, { origin: "A2" });
//         XLSX.utils.sheet_add_aoa(worksheet, [["", "", "", "", "", "", "Manpower Requisition"]], { origin: "A1" });
        
//         if (!worksheet["G1"].s) worksheet["G1"].s = {};
// worksheet["G1"].s = {
//     font: { bold: true }
// };
...
const handleExport = () => {
    ...
    const headerRow = sheet.addRow([
        ...
        "Requirement Type", "Project Name", "Replacement Detail",
